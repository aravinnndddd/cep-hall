        ...
        {!isEmailLogin ? (
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4 text-left">
            ...
            <div className="mt-4 p-3 bg-zinc-50 rounded-lg border border-zinc-100">
              <p className="text-[10px] text-zinc-400 uppercase font-bold tracking-wider mb-1">Test Credentials</p>
              <p className="text-xs text-zinc-600">Email: <span className="font-mono">admin@college.edu</span></p>
              <p className="text-xs text-zinc-600">Pass: <span className="font-mono">password123</span></p>
            </div>
          </form>
        )}
